...
const TYPE_LABEL_KEYS: Record<ActiviteitType, string> = {
  ...
  categorie_toegevoegd: 'activiteitTypeCategorieToegevoegd',
  categorie_gewijzigd: 'activiteitTypeCategorieGewijzigd',
  categorie_verwijderd: 'activiteitTypeCategorieVerwijderd',
