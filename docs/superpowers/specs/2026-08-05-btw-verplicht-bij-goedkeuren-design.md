...
> **Historisch ontwerpdocument.** Dit beschrijft het ontwerp zoals het op 05-08-2026 is vastgelegd, inclusief de afwegingen en verworpen alternatieven van dat moment. Het wordt bewust niet bijgewerkt wanneer de code later verandert — de waarde zit in het *waarom*.
>
