...
> **Historisch implementatieplan.** Dit is het stap-voor-stap plan zoals het op 01-08-2026 is opgesteld en uitgevoerd, inclusief de codefragmenten van dat moment. Het wordt bewust niet bijgewerkt wanneer de code later verandert — de waarde zit in het *waarom*.
>
