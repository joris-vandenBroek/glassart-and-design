  ...
  it('bouwt één mail met een sectie per klant, registreert de zending alleen bij de gekozen (niet-standaard) drukker, en zet beide bestellingen op "Verstuurd naar drukker"', async () => {
    ...
    try {
      ...
      const mail = buildDrukkerMail({
        bestellingen: [
          { id: headerX.id, klantId: klantX.id, companyName: klantX.email, bestelnr: headerX.bestelnr, besteldatum: '', status: 'Te versturen naar drukker', teVersturenNaarDrukkerOp: null, verstuurdNaarDrukkerOp: null, afgerondOp: null, afgewezenOp: null, lineCount: 1, totalQuantity: 1, lines: [{ id: 'l1', kunstwerkId, maatId: fixture.maatId, materiaalId: fixture.materiaalId, prijs: 80, quantity: 1 }] },
          { id: headerY.id, klantId: klantY.id, companyName: klantY.email, bestelnr: headerY.bestelnr, besteldatum: '', status: 'Te versturen naar drukker', teVersturenNaarDrukkerOp: null, verstuurdNaarDrukkerOp: null, afgerondOp: null, afgewezenOp: null, lineCount: 1, totalQuantity: 1, lines: [{ id: 'l2', kunstwerkId, maatId: fixture.maatId, materiaalId: fixture.materiaalId, prijs: 80, quantity: 1 }] },
        ],
        klanten: [],
