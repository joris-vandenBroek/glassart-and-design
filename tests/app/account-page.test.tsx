...
describe('AccountPage', () => {
  ...
  it('shows the under-construction page on the mijn.host build (pageAvailability.account is false)', async () => {
    const { default: AccountPage } = await import('@/app/[locale]/account/page');
