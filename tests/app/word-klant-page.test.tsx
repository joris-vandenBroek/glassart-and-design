...
describe('WordKlantPage', () => {
  ...
  it('shows the under-construction page on the mijn.host build (pageAvailability.wordKlant is false)', async () => {
    const { default: WordKlantPage } = await import('@/app/[locale]/word-klant/page');
